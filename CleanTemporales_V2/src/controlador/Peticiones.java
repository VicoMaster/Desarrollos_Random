...
public class Peticiones {
	...
	public void rescatar_Usuario() {
		System.out.println("Entro al metodo: rescatar usuario");
	...
	public void ejecutar_BorrarTEMP(String batch) {
		System.out.println("Ingreso al metodo: ejecutar_BorrarTEMP");
		Comando_CMD comando_cmd = new Comando_CMD();
	...
	public void construirBatch() {
		System.out.println("Ingreso al metodo: construirBatch");
	...
	public void construirBatch2() {
		System.out.println("Ingreso al metodo: construirBatch2");
		Construccion_Batch construir_batch = new Construccion_Batch();
	...
	public void construirBatch3() {
		System.out.println("Ingreso al metodo: construirBatch3");
		Construccion_Batch construir_batch = new Construccion_Batch();
	...
	public String limpiarCache() {
		System.out.println("Ingreso al metodo: limpiarCache");
		rescatar_Usuario();
		construirBatch();
		ejecutar_BorrarTEMP("borrar_temporales.bat");
		construirBatch2();
		System.out.println("Falló por aquí 9");
