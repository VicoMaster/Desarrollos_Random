...
public class Construccion_Batch {
	...
	public void creacion_Archivo(String nombre_batch) {
		System.out.println("Ingreso al metodo: creacion_Archivo");
		try {
	...
	public void escritura_Archivo(String ruta_usuario) {
		System.out.println("Ingreso al metodo: escritura_Archivo");
		try {
			FileWriter fr = new FileWriter(cmd_batch);
			String orden = "@echo off"+"\r\n"+"cd \""+ruta_usuario+"\\AppData\\Local\\Temp\""+"\r\n"+"RMDIR /S /Q \""+ruta_usuario
					+"\\AppData\\Local\\Temp\""
					+"\r\n"+"cd \""+ruta_usuario+"\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Cache\""
					+"\r\n"+"RMDIR /S /Q \""+ruta_usuario+"\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Cache\"";;
			fr.write(orden);
			fr.flush();
			fr.close();
		} catch (IOException e) {
	...
	public void escritura_Archivo2(String ruta_usuario) {
		System.out.println("Ingreso al metodo: escritura_Archivo2");
		try {
			FileWriter fr = new FileWriter(cmd_batch);
	...
	public void escritura_Archivo3(String ruta_usuario) {
		System.out.println("Ingreso al metodo: escritura_Archivo3");
		try {
			FileWriter fr = new FileWriter(cmd_batch);
