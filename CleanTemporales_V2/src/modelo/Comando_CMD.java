...
public class Comando_CMD {
	...
	public String iniciarOrden(String archivo) {
		System.out.println("Ingreso al metodo: iniciarOrden");
		String contenido = "";
		String linea = null;
		...
		try {
			...
			while ((linea = in.readLine()) != null) {
				System.out.println("Traza: SE ESTA QUEDANDO AQUI...");
				contenido += "\n"+linea.toString();
			}
		} catch (Exception e) {
			contenido += "Error: "+e;
	...
	public String direccion_Ruta(String contenido) {
		System.out.println("Ingreso al metodo: direccion_Ruta");
		System.out.println("LOG: RECUERDE QUE ESTE PROGRAMA DEBE ESTAR EN LA UNIDAD C: ");
